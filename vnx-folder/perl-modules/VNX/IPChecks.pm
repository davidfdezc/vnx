...
sub valid_ipv4 {
   ...
   # Changed 25[0-5]|2[0-4]\d|1\d\d|\d\d|\d to 25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d to support 0X or 0XX digits   
   if ($ip =~ /^(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)$/) {
      return 1;
   }
   else {
      return 0;
...
sub valid_ipv4_with_mask {
   ...
   if ($ip =~ /^(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\.(25[0-5]|2[0-4]\d|1\d\d|\d\d|0\d\d|\d|0\d|00\d)\/(3[0-2]|[1-2]\d|\d)$/) {
      return 1;
   }
   else {
      return 0;
